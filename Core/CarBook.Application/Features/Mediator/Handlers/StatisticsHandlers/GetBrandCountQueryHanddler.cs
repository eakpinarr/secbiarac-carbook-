...
{
    public class GetBrandCountQueryHanddler : IRequestHandler<GetBrandCountQuery, GetBrandCountQueryResult>
    {
        private readonly IStatisticsRepository _repository;

        public GetBrandCountQueryHanddler(IStatisticsRepository repository)
        {
