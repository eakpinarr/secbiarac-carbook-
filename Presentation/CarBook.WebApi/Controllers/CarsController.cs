...
namespace CarBook.WebApi.Controllers
{
    ...
    public class CarsController : ControllerBase
    {
        ...
        private readonly GetCarQueryHendler _getCarQureyHandler;
		...
		public CarsController(CreateCarCommandHandler createCarCommandHandler,
			GetCarByIdQueryHandler getCarByIdQueryHandler, GetCarQueryHendler getCarQureyHandler,
			...
			GetCarWithBrandQueryHandler getCarWithBrandQueryHandler, GetLast5CarsWithBrandQueryHandler getLast5CarsWithBrandQueryHandler)
		{
			...
			_getCarQureyHandler = getCarQureyHandler;
        ...
        {
            var values = await _getCarQureyHandler.Handle();
            return Ok(values);
        }
        [HttpGet("{id}")]
