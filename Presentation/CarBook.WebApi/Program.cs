...
builder.Services.AddScoped(typeof(IStatisticsRepository), typeof(StatisticsRepositories));
builder.Services.AddScoped(typeof(ICarFeatureRepository), typeof(CarFeaturesRepository));
builder.Services.AddScoped(typeof(ICarDescriptionRepository), typeof(CarDescriptionRepository));
builder.Services.AddScoped(typeof(IReviewRepository), typeof(ReviewRepository));

builder.Services.AddScoped<GetAboutQureyHandler>();
...
builder.Services.AddScoped<GetCarQueryHendler>();
